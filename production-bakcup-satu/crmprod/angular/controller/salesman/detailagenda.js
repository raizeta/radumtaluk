                ...
                angular.forEach(result.Customer, function(value, key) 
                {
                    ...
                    if(mts)
                    {
                        ...
                        ({
                              ...
                              url: url + "/gambarkunjungans/search?ID_DETAIL=" + ab.ID + "&IMG_NM=gambar start",
                              type: "GET",
                              dataType:"json",
                              async: false
                        });
                        ...
                        ({
                              ...
                              url: url + "/gambarkunjungans/search?ID_DETAIL=" + ab.ID + "&IMG_NM=gambar end",
                              type: "GET",
                              dataType:"json",
                              async: false
                        });
                        ...
                        ({
                              ...
                              url: url + "/productinventories/search?CUST_KD=" + idcustomer + "&TGL=" + tanggalinventory,
                              type: "GET",
                              dataType:"json",
                              async: false
                        }).responseText;
