...
function ($rootScope,$scope, $location, $http, authService, auth,$window,$routeParams,NgMap,LocationService,$cordovaBarcodeScanner,$cordovaCamera,$cordovaCapture,apiService,singleapiService,ngToast,$mdDialog,$filter,sweet) 
{
    ...
    $scope.checkout = $routeParams.idtanggal;
        ...
        .then(function (result) 
        {
            ...
            .then(function (result) 
            {
                if(result.DetailKunjungan)
                {
                    ...
                    $http.get(url + "/gambarkunjungans/search?ID_DETAIL=" + id + "&IMG_NM=gambar start",config)
                    ...
                    $http.get(url + "/gambarkunjungans/search?ID_DETAIL=" + id + "&IMG_NM=gambar end",config)
                    .success(function(data,status, headers, config) 
                    {
                        //console.log(data);
    ...
    ({
          url: url + "/productinventories/search?CUST_KD=" + idcustomer + "&TGL=" + tanggalinventory + "&SO_TYPE=6",
          type: "GET",
          dataType:"json",
          async: false
    }).responseText;
    ...
    ({
          url: url + "/productinventories/search?CUST_KD=" + idcustomer + "&TGL=" + tanggalinventory + "&SO_TYPE=7",
          type: "GET",
          dataType:"json",
          async: false
    }).responseText;
        ...
        document.addEventListener("deviceready", function () {
          ...
          $cordovaCamera.getPicture(options).then(function(imageData) 
          {
            ...
            .then(function (result) 
            {
                ...
                $http.post(url + "/gambarkunjungans",serialized,config)
                .success(function(data,status, headers, config) 
                {
