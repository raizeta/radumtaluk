'use strict';
myAppModule.factory('ProductService', ["$rootScope","$http","$q","$window","$cordovaSQLite", function($rootScope,$http, $q, $window, $cordovaSQLite)
{
	var getUrl = function()
	{
		        ...
		        .success(function(response) 
		        {
		            ...
		            else
		            {
				        ...
				        angular.forEach(response.BarangPenjualan, function(value, key)
				        {
	                        ...
	                        .then(function(result) 
	                        {
	                            alert("Barang Berhasil Disimpan Di Local!");
	                        }, 
	                        function(error) 
	                        {
