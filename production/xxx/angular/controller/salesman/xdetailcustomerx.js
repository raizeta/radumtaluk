        ...
        .then(function (result) 
        {
            ...
            .then(function (result) 
            {
                ...
                else
                {
                    ...
                    $http.put(url + "/detailkunjungans"+ id,serialized,config)
                    .success(function(data,status, headers, config) 
                    {
...
// #########################################################################################################################################
    ...
    var ProductSummary = JSON.parse(dataproduct)['BarangPenjualan'];
    ...
    angular.forEach(ProductSummary, function(value, key)
    {
        ...
        ({
              url: url + "/productinventories/search?CUST_KD=" + idcustomer + "&TGL=" + tanggalplan + "&SO_TYPE=6&KD_BARANG="+ summarikdbarang,
              type: "GET",
              dataType:"json",
              async: false
        }).responseText;
        ...
        ({
              url: url + "/productinventories/search?CUST_KD=" + idcustomer + "&TGL=" + tanggalplan + "&SO_TYPE=7&KD_BARANG="+ summarikdbarang,
              type: "GET",
              dataType:"json",
              async: false
        }).responseText;
        ...
        ({
              url: url + "/productinventories/search?CUST_KD=" + idcustomer + "&TGL=" + tanggalplan + "&SO_TYPE=5&KD_BARANG="+ summarikdbarang,
              type: "GET",
              dataType:"json",
              async: false
        }).responseText;
