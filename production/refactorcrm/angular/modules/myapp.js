...
function ($rootScope,$http,$location,LocationFac,$window,$q,$filter,$cordovaDevice,$timeout,$templateCache,$cordovaNetwork,$cordovaSQLite) 
{
    ...
    document.addEventListener("deviceready", function () 
    {
        ...
        $cordovaSQLite.execute($rootScope.db, 'CREATE TABLE IF NOT EXISTS Inventory (ID_LOCAL INTEGER PRIMARY KEY AUTOINCREMENT, ID INTEGER,TGL TEXT,CUST_KD TEXT,CUST_NM TEXT,KD_BARANG TEXT,NM_BARANG TEXT,SO_QTY INTEGER,SO_TYPE INTEGER,POS TEXT,USER_ID INTEGER,STATUS INTEGER,WAKTU_INPUT_INVENTORY TEXT,ID_GROUP INTEGER,DIALOG_TITLE TEXT,ISON_SERVER INTEGER)');
