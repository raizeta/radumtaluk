'use strict';
myAppModule.controller("SettingController",
function ($q,$rootScope,$scope,$location,$http,$filter,$window,auth,SettingFac) 
{   
    $scope.activesetting = "active";
    $scope.userInfo = auth;
