...
function ($rootScope,$http,$location,LocationService,$window,ngToast,authService,$q,$filter,$cordovaDevice,$timeout,$templateCache,$cordovaNetwork,$cordovaSQLite) 
{
    ...
    document.addEventListener("deviceready", function () 
    {
        ...
        $cordovaSQLite.execute($rootScope.db, 'CREATE TABLE IF NOT EXISTS Agenda (id INTEGER PRIMARY KEY AUTOINCREMENT, ID_SERVER INTEGER,TGL TEXT, USER_ID INTEGER, CUST_ID TEXT, CUST_NM TEXT, LAG TEXT, LAT TEXT, MAP_LAT TEXT, MAP_LNG TEXT, CHECKIN_TIME TEXT,CHECKOUT_TIME TEXT,CHECK_IN INTEGER, CHECK_OUT INTEGER, INVENTORY_EXPIRED INTEGER, INVENTORY_SELLIN INTEGER, INVENTORY_SELLOUT INTEGER, INVENTORY_STOCK INTEGER, REQUEST INTEGER,START_PIC INTEGER, END_PIC INTEGER, SCDL_GROUP INTEGER,ISON_SERVER INTEGER)');
        $cordovaSQLite.execute($rootScope.db, 'CREATE TABLE IF NOT EXISTS Statuskunjungan (ID INTEGER PRIMARY KEY AUTOINCREMENT, ID_DETAIL INTEGER, TGL TEXT, USER_ID INTEGER, CUST_ID TEXT, CUST_NM TEXT, CHECK_IN INTEGER, CHECK_OUT INTEGER, INVENTORY_EXPIRED INTEGER, INVENTORY_SELLIN INTEGER, INVENTORY_SELLOUT INTEGER, INVENTORY_STOCK INTEGER, REQUEST INTEGER,START_PIC INTEGER, END_PIC INTEGER,ISON_SERVER INTEGER)');
        ...
        $cordovaSQLite.execute($rootScope.db, 'CREATE TABLE IF NOT EXISTS Sot2 (ID INTEGER PRIMARY KEY AUTOINCREMENT, ISON_SERVER INTEGER,TGL TEXT,CUST_KD TEXT,KD_BARANG TEXT,SO_QTY INTEGER,SO_TYPE INTEGER,POS TEXT,USER_ID INTEGER,STATUS INTEGER,WAKTU_INPUT_INVENTORY TEXT,ID_GROUP INTEGER)');
