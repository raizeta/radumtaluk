...
function ($rootScope,$http,$location,LocationService,$window,ngToast,authService,$q,$filter,$cordovaDevice,$timeout,$templateCache,$cordovaNetwork,$cordovaSQLite) 
{
    ...
    document.addEventListener("deviceready", function () 
    {
        ...
        $cordovaSQLite.execute($rootScope.db, 'CREATE TABLE IF NOT EXISTS GagalCheck (ID INTEGER PRIMARY KEY AUTOINCREMENT,ID_AGENDA INTEGER,ID_CUSTOMER TEXT,WAKTU_CHECK TEXT,TYPE_CHECK TEXT,POS_LAT TEXT,POS_LAG TEXT,ISONSERVER INTEGER)');

        $cordovaSQLite.execute($rootScope.db, 'CREATE TABLE IF NOT EXISTS GagalGambar (ID INTEGER PRIMARY KEY AUTOINCREMENT,ID_AGENDA INTEGER,ID_CUSTOMER TEXT,WAKTU_GAMBAR TEXT,TYPE_GAMBAR TEXT,ISI_GAMBAR TEXT,ISONSERVER INTEGER)');
   });
