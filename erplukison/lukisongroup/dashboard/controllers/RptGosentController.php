...
use app\models\dashboard\Rptgosent;
use app\models\dashboard\RptgosentSearch;
 ...
 */
class RptGosentController extends Controller
{
	...
	*/
    ...
    {
        if (($model = Rptgosent::findOne($id)) !== null) {
            return $model;
        } else {
