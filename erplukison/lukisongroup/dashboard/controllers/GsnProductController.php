 ...
 */
class GsnProductController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->searchBarangGSN(Yii::$app->request->queryParams);
		...
		if(Yii::$app->request->isAjax){
			...
			if($ValidationLoginPrice->load(Yii::$app->request->post())){
				if ($ValidationLoginPrice->Validationlogin()){					
					return $this->redirect(['/dashboard/gsn-product/barang-price']);
				}														
			}
		}
	}
