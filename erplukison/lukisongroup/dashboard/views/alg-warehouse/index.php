...
$this->sideMenu = 'alg_warehouse';                              /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'ALG - Warehouse Dashboard ');     /* title pada header page */
