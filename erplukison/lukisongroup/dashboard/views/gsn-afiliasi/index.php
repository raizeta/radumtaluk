...
$this->sideMenu = 'gsn_afiliasi';                                       /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'Gosend - Affiliation Dashboard');         /* title pada header page */
