...
$this->sideMenu = 'esm_factory';                                    /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'ESM - Factoryn Dashboard');           /* title pada header page */
