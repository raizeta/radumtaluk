...
$this->sideMenu = 'gsn_purchasing';                                       /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'Gosend - Purchasing Dashboard');            /* title pada header page */
