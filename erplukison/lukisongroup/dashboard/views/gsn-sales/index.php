...
$this->sideMenu = 'gsn_sales';                                       /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'Gosend - Sales Dashboard');            /* title pada header page */
