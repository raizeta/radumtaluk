...
$this->sideMenu = 'sss_marketing';                                  /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'SSS - Marketing Dashboard');          /* title pada header page */
