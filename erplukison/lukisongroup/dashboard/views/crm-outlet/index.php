...
$this->sideMenu = 'crm_outlet';                                 /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'ESM - Outlet Dashboard');         /* title pada header page */
