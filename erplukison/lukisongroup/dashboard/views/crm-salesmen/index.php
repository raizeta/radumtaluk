...
$this->sideMenu = 'crm_salesmen';                                   /* kd_menu untuk list menu pada sidemenu, get from table of database */
$this->title = Yii::t('app', 'ESM - Salesmen Dashboard');            /* title pada header page */
