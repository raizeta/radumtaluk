...
/* VARIABLE PRIMARY JOIN/SEARCH/FILTER/SORT Author: -ptr.nov- */
	use lukisongroup\hrd\models\Modulset;			/* TABLE CLASS JOIN */
	use lukisongroup\hrd\models\ModulsetSearch;		/* TABLE CLASS SEARCH */

/**
 * HRD | CONTROLLER MODUL HRD .
 */
class ModulsetController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel_Mdlhrd = new ModulsetSearch();
    ...
    {
        if (($model = Modulset::findOne($id)) !== null) {
            return $model;
        } else {
