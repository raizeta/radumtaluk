<?php
	...
	$items = [
		[
			...
			'icon' => 'play-circle',
			'content' => $erp_introduction,
			'items' => [
				['url' => '#sec-1-1', 'label' => 'STATUS', 'content' => $content],
				['url' => '#sec-1-2', 'label' => 'VALIDATION', 'content' => $content],
				['url' => '#sec-1-3', 'label' => 'DDL', 'content' => $content],
				['url' => '#sec-1-4', 'label' => 'DML', 'content' => $content],
			],
		],
		/* [
			'url' => '#Purchasing-1',
...
<div class="content" style="font-family: verdana, arial, sans-serif ;font-size: 9pt";>
	<div class="row">
		<div class="col-md-12">
			<h4 class="text-center"><b>LUKISONGROUP TIPS ERP GUIDE</b></h4>
			<hr/>
		</div>
	</div>
